# Research Starter Lab constitution

- Mission: teach general student research across disciplines. Saturn/PRIMES is one clearly labeled physics example, never the product identity.
- Product loop: help students **see → try → understand → save → continue** through Learn, Build, See, and Record modes.
- Pedagogy: prefer learn-by-doing. An interaction must clarify a concept or create useful student work.
- Hierarchy: Level 1 current idea/action; Level 2 evidence/example; Level 3 navigation/metadata; Level 4 decoration. Decoration never outranks evidence.
...
- Label constructed teaching material **WORKED EXAMPLE** and actual projects **REAL PROJECT EXAMPLE**.
