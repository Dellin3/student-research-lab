...
export default function FindDirectionPage() {
  return <><RouteSeo path="/find-a-direction" /><PageIntro eyebrow="Choose a direction" title="Make the interest specific." description="Name what you will study, how you will look at it, and where the first attempt stops." />
    <main id="main-content" className="page-content guide-reading">
      ...
      <section className="guide-example"><p className="example-label">WORKED EXAMPLE</p><h2>“Climate change” becomes a place to look.</h2><p>Study the relationship between tree cover and summer surface temperature in one city. The object, lens, and boundary are clear; the question comes next.</p></section>
